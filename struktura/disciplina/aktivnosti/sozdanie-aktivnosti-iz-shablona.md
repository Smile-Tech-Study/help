...
Если при создании активности вы выбрали неподходящий шаблон, его можно сменить на странице  редактирования Активности.

![](./sozdanie-aktivnosti-iz-shablona.png){width=1021px height=205px}