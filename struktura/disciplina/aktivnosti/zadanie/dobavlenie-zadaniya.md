---
title: Задание и его добавление
order: 2
---
...
### Про сроки сдачи решения к заданию

В активности с типом «Задание» при проставленной галке для чекбокса "Разрешить отправлять решения после даты окончания" под ней показывается обязательное поле для выбора даты и времени с названием "Итоговый срок сдачи".

![](./dobavlenie-zadaniya.png){width=540px height=300px}

Смысл в том, что у заданий есть дедлайн всегда.

Приоритет дат будет следующий: Индивидуальный срок сдачи -> Срок сдачи для активности -> Дата завершения потока -> Дата завершения активности.

Индивидуальный срок важнее всех, если он установлен. Если его нет, то указанный дедлайн (который после окончания активности) для всех участников активности приоритетнее. После уже идет проверка на то, чтобы решение вписывалось в сроки проведения потока и активности.