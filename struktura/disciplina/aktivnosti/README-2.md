...
![](./README-2.png){width=918px height=648px}

Группировать Активности можно в Модуль и/или Тему.
...
6. Добавьте [**материалы**](./../../../servisy/biblioteka/dobavlenie-materialov-2)**.**
...
-  онлайн. Занятие может быть проведено, как:
   ...
   -  Асинхронная активность (самостоятельное изучение)  - студент пройдет активность в удобное время и не будет привязан ко времени звонка.
