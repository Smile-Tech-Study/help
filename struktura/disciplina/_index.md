...
![](./disciplina-2.png){width=948px height=542px}
...
![](./disciplina-3.png){width=641px height=185px}
...
-  **Уведомлять студентов о предстоящем занятии**

Если настройка/настройки будут включены, преподаватель получит уведомление о новом решении/ выполнении контрольной студента, а студент -  о предстоящем занятии. Оповещения придут в виде push-уведомления и отобразятся в блоке Уведомления на дашборде.

![](./disciplina-5.png){width=642px height=242px}
...
![](./disciplina-4.png){width=650px height=181px}
