...
На данной вкладке определяется порядок активностей в дисциплине, их группировка по Модулям/Темам. Здесь Студенты проходят обучение, последовательно изучая активности, выполняя задания и тесты.  

![](./stranica-discipliny-2.png){width=934px height=1050px}
...
Материалы видны всем, кто имеет доступ к Дисциплине, кроме материалов с типом Тест (он виден студенту только в активности) и Шаблон активности/дисциплины (не виден студенту).
...
![](./stranica-discipliny-3.png){width=894px height=565px}

Автоматически после добавления материала в Активность, в том числе, если активность создана из шаблона, в библиотеке новой Дисциплины появляется каталог "Материалы из образовательных активностей".
...
![](./stranica-discipliny-4.png){width=958px height=697px}
...
![](./stranica-discipliny-5.png){width=1021px height=195px}

Последний столбец - Итоговая оценка по дисциплине.

-  Выставить **Итоговые оценки (ведомость)**

   ![](./stranica-discipliny-6.png){width=954px height=270px}
...
-  ![](./stranica-discipliny-7.png){width=964px height=1131px}
   ...
   **Если студент набрал по дисциплине 3,5 балла и выше - выставляется Зачтено.**
   ...
   ![](./stranica-discipliny-8.png){width=726px height=185px}
...
![](./stranica-discipliny-9.png){width=1016px height=819px}

Для выгрузки таблицы посещаемости надо кликнуть на три точки и экспортировать в Excel.

![](./stranica-discipliny-10.png){width=974px height=186px}

На вкладке Посещаемость доступна фильтрация студентов.

![](./stranica-discipliny-11.png){width=1010px height=316px}
...
![](./stranica-discipliny-12.png){width=573px height=98px}
...
-  Действия студента - наглядное представление о том, сколько действий и в какой день в системе Odin совершил студент.
   ...
   ![](./stranica-discipliny.png){width=927px height=351px}
