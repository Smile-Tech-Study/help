...
-  Структура образовательной программы. Загрузить скан рабочей программы в формате pdf. **Программа должна быть подписана со стороны организации, затем отсканирована и загружена.**

-  Администратор/администраторы. Пользователи должны пройти самостоятельную [регистрацию](./../../../../roli-v-sisteme/registraciya), после этого их можно выбрать при вводе ФИО, e-mail или ссылки на профиль в поле Администраторы.
...
Следует выбрать образовательный проект, если программа к нему относится, либо оставить это поле пустым.

:::note 

**Важно! Снять галочку проекта после сохранения вы не сможете!** Если вы пока заполняете программу и не хотите отправлять данные о ней во Flow и далее на портал РР, временно оставьте поле пустым.
