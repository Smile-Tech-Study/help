...
Например, Поток занимается 1 учебный год, их курс увеличивается. То есть, год набора 2026 - студенты первого курса, студенты прошли обучение в рамках одного **осеннего** и одного **весеннего** семестра, теперь их курс стал вторым.

### Как добавить семестр?

Добавить семестр можно на странице Потока по кнопке "Добавить":

![](./dobavlenie-semestra.png){width=971px height=1065px}
