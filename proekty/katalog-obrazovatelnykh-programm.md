...
Раздел «Размещение программы в каталоге» предназначен для публикации образовательной программы в общем каталоге <https://www.odin.study/marketplace/catalog>, где потенциальные слушатели могут ознакомиться с программой, изучить условия обучения и выбрать подходящую.
...
В этом поле выбирается категория, к которой относится образовательная программа. Категория используется для навигации, поиска и фильтрации программ в каталоге. Корректный выбор категории помогает пользователям быстрее находить подходящие курсы.
...
В этом поле необходимо кратко описать итог прохождения курса. Рекомендуется отвечать на вопрос: что сможет делать слушатель после завершения программы?
