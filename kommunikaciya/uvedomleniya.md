...
В системе есть возможность рассылать уведомления не только в [**Чате**](./chat/_index). Например, Администратору университета требуется быстро отправить сообщение всем преподавателям или администратору подразделения пригласить студентов  нескольких потоков на вводное занятие.
