...
Если вдруг ошибка сохраняется, тогда надо установить корневой сертификат Минцифры с сайта <https://www.gosuslugi.ru/crt> из раздела «Windows». Для удобства пользователей там содержится видеоинструкция по установке. Устанавливать следует именно корневые сертификаты, а не выпускающие (от них не будет вреда, но для входа они не потребуются).
