...
Если у вас установлен браузер Opera ![](./kesh-brauzera-chto-eto-i-zachem-ego-ochishat-8.png){width=120px height=120px}
...
![](./kesh-brauzera-chto-eto-i-zachem-ego-ochishat-9.png){width=1915px height=1012px}

Заходим в настройки браузера

![](./kesh-brauzera-chto-eto-i-zachem-ego-ochishat-10.png){width=1919px height=1030px}

В пункте "Безопасность и конфиденциальность" нажимаем "Очистить историю посещений"

![](./kesh-brauzera-chto-eto-i-zachem-ego-ochishat-11.png){width=1913px height=1015px}

Выбираем временной диапазон, ставим или снимаем галочки, оставляя "Кэшированные изображения и файлы", удаляем данные.
