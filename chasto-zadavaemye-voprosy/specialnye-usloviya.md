...
-  **Субтитры** доступны в загруженных в систему видеоматериалах (материал должен быть добавлен в систему не ранее 2023 года и иметь тип  Файл). Такая возможность подключается на платной основе, за подробностями можно обратиться [в поддержку](https://forms.yandex.ru/cloud/659fee4673cee70f5b63b79a/?answer_non_profile_email_41288802=l.maksimec@tgu-dpo.ru&answer_url_41279152=https://www.odin.study/ru/User/Info/37078).
