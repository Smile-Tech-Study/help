...
-  **Шаблоны программ** – позволяет заранее создать шаблон для быстрого добавления потока с заранее заданным набором дисциплин. [Подробнее](./../../../instrukcii-po-rabote/page)
...
-  **Опрос** -  при создании этого материала открывается конструктор опросов, где можно добавить вопросы, варианты и блоки, страницы. [Подробнее](./oprosy)