...
Отметки о посещении будут выставлены, если студент зайдёт на страницу активности и нажмет кнопку “Завершить активность”. (Для активностей [Задание](./../../struktura/disciplina/aktivnosti/zadanie/_index) - следует отправить решение и дождаться проверки, для активности с типом [Контрольная](./../../struktura/disciplina/aktivnosti/kontrolnaya/_index)[ ](./../../servisy/biblioteka/materialy/test/_index)\- пройти тест). После этого галочка на посещении активности будет выставлена автоматически.