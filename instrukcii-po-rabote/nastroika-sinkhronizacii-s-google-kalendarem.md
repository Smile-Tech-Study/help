...
Шаг 5. Далее надо открыть раздел "Имеют доступ" и нажать на кнопку "Добавить пользователей или группу». Пользователю важно проверить:

-  Правильность указания почты Odin. Следует использовать service@lmsodincalendar.iam.gserviceaccount.com.
