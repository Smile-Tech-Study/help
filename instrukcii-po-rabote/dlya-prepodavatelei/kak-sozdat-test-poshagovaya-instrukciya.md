...
При создании теста необходимо определиться, ответ какого типа будет добавлен к каждому конкретному вопросу. Один тест может содержать различные вариации вопросов с разными типами ответов. Всего возможны 6 вариантов (про вариант с заполнением пропусков описано под таблицей):

[tabs]

[tab:Выбор из вариантов]
...
![](./kak-sozdat-test-poshagovaya-instrukciya.png){width=1480px height=1328px}
...
-  диапазон - диапазон устанавливается в случае, когда верным ответом станет число, попадающее в определенный промежуток чисел "от" и "до".
   ...
   ![](./kak-sozdat-test-poshagovaya-instrukciya-2.png){width=1666px height=1053px}
...
![](./kak-sozdat-test-poshagovaya-instrukciya-3.png){width=1666px height=920px}
...
![](./kak-sozdat-test-poshagovaya-instrukciya-4.png){width=1400px height=1133px}
...
![](./kak-sozdat-test-poshagovaya-instrukciya-5.png){width=1386px height=1133px}

[/tab]

[/tabs]

Также есть тип вопросов на **заполнение пропусков**. В этом варианте возможен как точный ответ, так и свободный для дальнейшей проверки ответственным. Выбрать можно при создании теста.

![](./kak-sozdat-test-poshagovaya-instrukciya-6.png){width=651px height=686px}

При выборе точного ответа система засчитает верным ответ, идентичный введенному при составлении теста. Например:

![](./kak-sozdat-test-poshagovaya-instrukciya-7.png){width=612px height=282px}

Если же требуется свободный ответ для дальнейшей проверки, тогда надо выбрать кнопку «Свободный ответ».

![](./kak-sozdat-test-poshagovaya-instrukciya-8.png){width=605px height=268px}

Для проверки можно выбрать, будет ли ошибочно или нет, если пользователь впишет ответ с маленькой буквы. Например, если для проверки указано слово «Москва», то можно ли считать верным ответ «москва». Это выбирается вот здесь:

![](./kak-sozdat-test-poshagovaya-instrukciya-9.png){width=645px height=281px}

И также можно указать, как будут считаться баллы за такой вопрос: только если за все верные ответы, либо за каждый из правильных ответов.

![](./kak-sozdat-test-poshagovaya-instrukciya-10.png){width=655px height=328px}
